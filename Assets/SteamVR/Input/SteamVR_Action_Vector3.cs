...
namespace Valve.VR
{
    ...
    public class SteamVR_Action_Vector3 :
        SteamVR_Action_In<SteamVR_Action_Vector3_Source_Map, SteamVR_Action_Vector3_Source>, ISteamVR_Action_Vector3,
        ISerializationCallbackReceiver
    {
        public delegate void AxisHandler(SteamVR_Action_Vector3 fromAction, SteamVR_Input_Sources fromSource,
            Vector3 axis, Vector3 delta);

        public delegate void ActiveChangeHandler(SteamVR_Action_Vector3 fromAction, SteamVR_Input_Sources fromSource,
            bool active);

        public delegate void ChangeHandler(SteamVR_Action_Vector3 fromAction, SteamVR_Input_Sources fromSource,
            Vector3 axis, Vector3 delta);

        public delegate void UpdateHandler(SteamVR_Action_Vector3 fromAction, SteamVR_Input_Sources fromSource,
            Vector3 axis, Vector3 delta);
        ...
        public Vector3 axis
        {
            get { return sourceMap[SteamVR_Input_Sources.Any].axis; }
        }
        ...
        {
            get { return sourceMap[SteamVR_Input_Sources.Any].lastAxis; }
        }
        ...
        {
            get { return sourceMap[SteamVR_Input_Sources.Any].delta; }
        }
        ...
        {
            get { return sourceMap[SteamVR_Input_Sources.Any].lastDelta; }
        }
