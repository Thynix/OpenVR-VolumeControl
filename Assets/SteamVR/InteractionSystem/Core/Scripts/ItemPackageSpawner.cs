...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ItemPackageSpawner : MonoBehaviour
    {
        ...
        public bool
            takeBackItem =
                false; // if a hand enters this trigger and has the item this spawner dispenses at the top of the stack, remove it from the stack
        ...
        private void CreatePreviewObject()
        {
            ...
            if (useItemPackagePreview)
            {
                ...
                else // there's a spawned item out there. Use the faded preview
                {
                    ...
                    {
                        previewObject =
                            Instantiate(itemPackage.fadedPreviewPrefab, transform.position,
        ...
        {
            Debug.LogError("<b>[SteamVR Interaction]</b> ItemPackage assigned to " + gameObject.name +
        ...
        private void RemoveMatchingItemsFromHandStack(ItemPackage package, Hand hand)
        {
            ...
            {
                ItemPackageReference packageReference =
        ...
        private void SpawnAndAttachObject(Hand hand, GrabTypes grabType)
        {
            ...
            if (itemPackage.otherHandItemPrefab != null)
            {
                ...
                {
                    Debug.Log(
                        "<b>[SteamVR Interaction]</b> Not attaching objects because other hand is hoverlocked and we can't deliver both items.");
                    return;
                }
            }
